...
import com.fz.entity.enums.UserSexEnum;
import com.fz.entity.enums.UserStatuseEnum;
...
public class UserInfoServiceImpl implements UserInfoService {
	 ...
	 * 更新用户信息
	 * @param userInfo 用户信息
	 * @param tokenUserInfoDto token中的用户信息
	 * @throws BusinessException 硬币不足，无法修改昵称
	 * @author fz
	 * 2024/12/6 11:20
	 */
	@Override
