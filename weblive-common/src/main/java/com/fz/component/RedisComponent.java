...
public class RedisComponent {
    ...
    /**
     * @description: 根据验证key获取验证码
     * @param checkCoedKey 验证码key
     * @return 验证码
     * @author fz
     * 2024/12/5 12:07
     */
    ...
    public String savePreVideoFileInfo(String uid, String fileName, Integer chunks) {
        ...
        // 创建文件保存目录
        // 以天为单位创建视频存放目录,比如20241208/uid+uploadId
    ...
    /**
     * 获取视频文件信息
     * @param uid 用户id uploadId 上传文件id
     * @return 视频文件信息
     * @author fz
     * 2024/12/8 13:13
     */
    ...
    /**
     * 删除视频文件信息
     * @param userId 用户id uploadId 上传文件id
     * @author fz
     * 2024/12/8 15:05
     */
     ...
     * @param deviceId 设备id
     * @return java.lang.Integer 当前在线人数
     * @author fz
     * 2025/1/11 10:47
     */
     ...
     * @param
     * @return com.fz.entity.dto.VideoPlayInfoDto
     * @author fz
     * 2025/1/14 12:57
     */
    ...
    public void recordVideoPlayCount(String videoId){
        ...
        //按天记录视频播放量 key:video_play_count:2024-01-15 field:videoId value:count
    ...
    public Map<String,Integer> getVideoPlayCount(String date){
        ...
        return videoPlayMap == null ? Collections.emptyMap() : videoPlayMap;
    }

    /**
     * @description: 删除某几天的视频播放量记录
     * @param keys
     * @author fz
     * 2025/1/15 10:28
     */
